@extends('layouts.personal')
    @section('meta')
    <title>@lang('pe_profile.title')</title>
    <meta name="description" content="smart Control Horario my profile, view my profile, and update my personal information.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">@lang('pe_profile.page_title')
                    <a href="{{ url('personal/profile/edit') }}" class="ui basic blue button mini offsettop5 float-right"><i class="ui icon edit"></i>@lang('pe_profile.edit')</a>
                </h2>
            </div>    
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 float-left">
                <div class="box box-success">
                    <div class="box-header with-border">@lang('pe_profile.person_info')</div>
                    <div class="box-body employee-info">
                            <table class="tablelist">
                                <tbody>
                                    <tr>
                                        <td><p>@lang('pe_profile.civil_status')</p></td>
                                        <td><p>@isset($profile->civilstatus) {{ $profile->civilstatus }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>@lang('pe_profile.age')</p></td>
                                        <td><p>@isset($profile->age) {{ $profile->age }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>@lang('pe_profile.height')<span class="help">(cm)</span></p></td>
                                        <td><p>@isset($profile->height) {{ $profile->height }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>@lang('pe_profile.weight')<span class="help">(pounds)</span></p></td>
                                        <td><p>@isset($profile->weight) {{ $profile->weight }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>@lang('pe_profile.gender')</p></td>
                                        <td><p>@isset($profile->gender) {{ $profile->gender }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>@lang('pe_profile.birthday')</p></td>
                                        <td><p>
                                    ...
                                    <tr>
                                        <td><p>@lang('pe_profile.dateregularized')</p></td>
                                        <td><p>
