@extends('layouts.personal')
    @section('meta')
    <title>@lang('pe_attend.title')</title>
    <meta name="description" content="smart Control Horario my attendance, view all my attendances, and clock-in/out.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            <h2 class="page-title">@lang('pe_attend.page_title')</h2>
            </div>    
        </div>
            ...
            <div class="box box-success">
                <div class="box-body reportstable">
                    <form action="" method="get" accept-charset="utf-8" class="ui small form form-filter" id="filterform">
                        ...
                        <div class="inline two fields">
                            <div class="three wide field">
                                <label>@lang('pe_attend.date_range')</label>
                            ...
                            <button id="btnfilter" class="ui button positive small"><i class="ui icon filter alternate"></i> @lang('pe_attend.filter')</button>
                        </div>
                    </form>
                    ...
                    <table width="100%" class="table table-bordered table-hover" id="dataTables-example" data-order='[[ 0, "desc" ]]'>
                        <thead>
                            <tr>
                                <th>@lang('pe_attend.date')</th>
                                <th>@lang('pe_attend.timein')</th>
                                <th>@lang('pe_attend.timeout')</th>
                                <th>@lang('pe_attend.hours')</th>
                                <th>@lang('pe_attend.status')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @isset($a)
