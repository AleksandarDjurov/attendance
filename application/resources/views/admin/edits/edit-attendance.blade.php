@extends('layouts.default')
    @section('meta')
    <title>@lang('attend.title_edit')</title>
    <meta name="description" content="smart Control Horario edit employee attendance.">
    @endsection 
    ...
    <div class="container-fluid">
        <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">@lang('attend.edit_attendance')</h2>
        </div>    
        </div>
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-content">
                    ...
                    @if($a->timeout != null)
                        <div class="field">
                            <label for="">@lang('attend.time_in')</label>
                            @isset($a->timein) 
                                @php 
                    ...
                    @else
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label for="">@lang('attend.time_in_date')</label>
                                <input class="readonly" type="text" placeholder="Date" name="date" value="@isset($a->date){{ $a->date }}@endisset" readonly="" />
                            </div>
                        </div>
                    @endif
                    ...
                    @if($a->timeout != null)
                        <div class="field">
                            <label for="">@lang('attend.time_out')</label>
                                @php 
                    ...
                    @else
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label for="">@lang('attend.time_out_date')</label>
