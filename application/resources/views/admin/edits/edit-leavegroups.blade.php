@extends('layouts.default')
    @section('meta')
    <title>@lang('empl.title_leave_group')</title>
    <meta name="description" content="smart Control Horario edit leave groups.">
    @endsection  
    ...
    <div class="container-fluid">
        <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">@lang('empl.edit_leave_group')</h2>
        </div>    
        </div>
        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="field">
                        <label>@lang('empl.leave_pri')</label>
