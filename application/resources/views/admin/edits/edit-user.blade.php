...
<meta name="description" content="smart Control Horario edit user.">
@endsection 
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">@lang('user.edit_user')</h2>
        </div>
    </div>
            ...
            <div class="box box-success">
                <div class="box-content">
                    ...
                    <form id="edit_user_form" action="{{ url('users/update/user') }}" class="ui form add-user" method="post"
                        ...
                        {{ csrf_field() }}
                        <div class="field">
                            <label>@lang('user.employee')</label>
                        ...
                        <div class="field">
                            ...
                            <select class="ui dropdown uppercase" name="status">
                                <option value="">@lang('user.select_status')</option>
                        ...
                        <div class="two fields">
                            <div class="field">
                                <label for="">@lang('user.new_pass')</label>
                                <input type="password" name="password" class="" placeholder="********">
                            </div>
                            <div class="field">
                                <label for="">@lang('user.confirm_new_pass')</label>
