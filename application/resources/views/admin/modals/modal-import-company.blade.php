...
<div class="ui modal tiny import">
    <div class="header">@lang('modal.import_company')</div>
    <div class="content">
    <form action="{{ url('import/fields/company') }}" class="ui form" method="post" accept-charset="utf-8"enctype="multipart/form-data" >
    {{ csrf_field() }}
        <div class="field">
