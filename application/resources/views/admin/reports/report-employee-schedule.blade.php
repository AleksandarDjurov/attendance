@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">@lang('report.employee_schedule')
                        ...
                        <div class="inline three fields">
                            <div class="three wide field">
                                <select name="employee" class="ui search dropdown getid">
                                    <option value="">@lang('report.employee')</option>
                                    @isset($employee)
                            ...
                            <button id="btnfilter" class="ui icon button positive small inline-button"><i class="ui icon filter alternate"></i> @lang('report.filter')</button>
                            <button type="submit" name="submit" class="ui icon button blue small inline-button"><i class="ui icon download"></i> @lang('report.download')</button>
                        </div>
                    </form>
                    ...
                    <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('report.start_time')</th>
                                <th>@lang('report.off_time')</th>
                                <th>@lang('report.start_date') </th>
                                <th>@lang('report.end_date')</th>
                                <th>@lang('report.hour')</th>
                                <th>@lang('report.rest_day')<span class="help">(s)</span></th>
