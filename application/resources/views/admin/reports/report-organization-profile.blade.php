@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">@lang('report.organiz_profile')
        ...
        <div class="row columnview">
            ...
            <div class="col-md-6 colview">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.company_population')</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.department_population')</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.gender_demo')</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.age_demo')</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.civil_demo')</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('report.employee_hire')</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
