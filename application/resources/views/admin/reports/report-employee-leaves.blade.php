@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">@lang('report.employee_report')
                    ...
                    <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('report.leave_from') <span class="help">(@lang('report.date'))</span></th>
                                <th>@lang('report.leave_to') <span class="help">(@lang('report.date'))</span></th>
                                <th>@lang('report.reason')</th>
