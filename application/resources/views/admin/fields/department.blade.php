@extends('layouts.default')
    @section('meta')
    <title>@lang('company.title_department')</title>
    <meta name="description" content="smart Control Horario departments, view departments, and export or download departments.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">@lang('company.add_department')
            ...
            <div class="col-md-4">
                <div class="box box-success">
                    ...
                    <form id="add_department_form" action="{{ url('fields/department/add') }}" class="ui form" method="post" accept-charset="utf-8">
                        {{ csrf_field() }}
                        <div class="field">
                            <label>@lang('company.department_name') <span class="help">@lang('company.acounting')</span></label>
