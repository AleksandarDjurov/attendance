@extends('layouts.default')
    ...
    <meta name="description" content="smart Control Horario companies, view companies, and export or download companies.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">@lang('company.add_company')
            ...
            <div class="col-md-4">
                <div class="box box-success">
                    ...
                    <form id="add_company_form" action="{{ url('fields/company/add') }}" class="ui form" method="post" accept-charset="utf-8">
                        {{ csrf_field() }}
                        <div class="field">
                            <label>@lang('company.company_name') <span class="help">e.g. "Apple Corporation"</span></label>
