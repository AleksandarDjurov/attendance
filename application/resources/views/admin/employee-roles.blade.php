@extends('layouts.default')
    ...
    <meta name="description" content="smart Control Horario roles, view all employee roles, add roles, edit roles, and delete roles.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">@lang('empl.user_role')
                <button class="ui positive button mini offsettop5 btn-add float-right"><i class="ui icon plus"></i>@lang('empl.add')</button>
                <a href="{{ url('users') }}" class="ui basic blue button mini offsettop5 float-right"><i class="ui icon chevron left"></i>@lang('empl.return')</a>
            </h2>
        </div>
