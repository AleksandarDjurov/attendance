@extends('layouts.default')
    @section('meta')
    <title>@lang('setting.title')</title>
    <meta name="description" content="smart Control Horario settings, view and update system settings.">
    @endsection 
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">@lang('setting.general_setting')</h2>
            </div>    
        </div>
            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <div class="ui secondary blue pointing tabular menu">
                        <a class="item active" data-tab="system">@lang('setting.stystem')</a>
                        <a class="item" data-tab="about">@lang('setting.about')</a>
                        <a class="item" data-tab="attribution">@lang('setting.attribution')</a>
                        <a class="item" data-tab="activation">@lang('setting.activation')</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                    ...
                                    <div class="content">
                                        ...
                                        {{ csrf_field() }}
                                            ...
                                            <div class="eight wide field">
                                                <label>@lang('setting.country')</label>
                                            ...
                                            <div class="eight wide field">
                                                <label>@lang('setting.timezone')</label>
                                            ...
                                            <div class="eight wide field">
                                                <label>@lang('setting.optional_clock')</label>
                                                <select name="clock_comment" class="ui dropdown uppercase">
                                                    <option value="">Select Status</option>
                                                    <option value="1" @isset($data->clock_comment) @if($data->clock_comment == 1) selected @endif @endisset>@lang('setting.enable')</option>
                                                    <option value="0" @isset($data->clock_comment) @if($data->clock_comment == 0) selected @endif @endisset>@lang('setting.disable')</option>
                                                </select>
                                            </div>
                                            <div class="eight wide field">
                                                <label>@lang('setting.web_clock')</label>
                                    ...
                                    <div class="actions align-left">
                                        <button class="ui positive small button approve" type="submit" name="submit"><i class="ui checkmark icon"></i> @lang('setting.update')</button>
                                        <a href="{{ url('dashboard') }}" class="ui grey small button cancel"><i class="ui times icon"></i> @lang('setting.cancel')</a>
                                    </div>
                                    </form> 
                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                    <h3 style="margin-top:0" class="ui header">@lang('setting.smart_h3')</h3>
                                    <p>@lang('setting.smart_p')</p>

                                    <h4 class="ui header">@lang('setting.feature')</h4>
                                    <ul>
                                        <li>@lang('setting.msg_li1')</li>
                                        <li>@lang('setting.msg_li2')</li>
                                        <li>@lang('setting.msg_li3')</li>
                                        <li>@lang('setting.msg_li4')</li>
                                        <li>@lang('setting.msg_li5')</li>
                                        <li>@lang('setting.msg_li6')</li>
                                        <li>@lang('setting.msg_li7')</li>
                                        <li>@lang('setting.msg_li8')</li>
                                    </ul>
                                    <div class="footer-text">
                                        <div class="sub header">@lang('setting.version')</div>
                                        <div class="sub header">@lang('setting.copyright')</div>
                                    </div>
                                </p>

                                <div class="ui section divider"></div>
                                <h4 class="ui header">@lang('setting.feedback')
                                    <div class="sub header">@lang('setting.feedback_msg')</div>
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ui tab" data-tab="attribution">
                        <div class="tab-content">
                        <h3 class="ui header">@lang('setting.legal_notice')
                        <div class="sub header">@lang('setting.copyright_legal')</div>
                        </h3>

                        <h5 class="ui header">@lang('setting.laravel')
                        <div class="sub header">@lang('setting.license')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_taylor')
                            <br><br>
                            @lang('setting.copyright_msg1')
                            <br><br>
                            @lang('setting.copyright_msg2')
                            <br><br>
                            @lang('setting.copyright_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.bootstrap')
                        <div class="sub header">@lang('setting.mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_twitter')
                            <br><br>
                            @lang('setting.copyright_twitter1')
                            <br><br>
                            @lang('setting.copyright_twitter2')
                            <br><br>
                            @lang('setting.copyright_twitter3')
                        </p>

                        <h5 class="ui header">@lang('setting.semantic')
                        <div class="sub header">@lang('setting.semantic_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_semantic')
                            <br><br>
                            @lang('setting.semantic_msg1')
                            <br><br>
                            @lang('setting.semantic_msg2')
                            <br><br>
                            @lang('setting.semantic_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.jquery')
                        <div class="sub header">@lang('setting.jquery_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_jquery')
                            <br><br>
                            @lang('setting.jquery_msg1')
                            <br><br>
                            @lang('setting.jquery_msg2')
                            <br><br>
                            @lang('setting.jquery_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.datatable')
                        <div class="sub header">@lang('setting.datatable_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_datatable')
                            <br><br>
                            @lang('setting.datatable_msg1')
                            <br><br>
                            @lang('setting.datatable_msg2')
                            <br><br>
                            @lang('setting.datatable_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.chart')
                        <div class="sub header">@lang('setting.chart_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_chart')
                            <br><br>
                            @lang('setting.chart_msg1')
                            <br><br>
                            @lang('setting.chart_msg2')
                            <br><br>
                            @lang('setting.chart_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.picker')
                        <div class="sub header">@lang('setting.picker_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_picker')
                            <br><br>
                            @lang('setting.picker_msg1')
                            <br><br>
                            @lang('setting.picker_msg2')
                            <br><br>
                            @lang('setting.picker_msg3')
                        </p>

                        <h5 class="ui header">@lang('setting.timepicker')
                        <div class="sub header">@lang('setting.timepicker_mit')</div>
                        </h5>
                        <p class="license col-md-6">
                            @lang('setting.copyright_timepicker')
                            <br><br>
                            @lang('setting.timepicker_msg1')
                            <br><br>
                            @lang('setting.timepicker_msg2')
                            <br><br>
                            @lang('setting.timepicker_msg3')
                        </p>
                        </div>
                    </div>

                    <div class="ui tab" data-tab="activation">
                        <div class="col-md-12">
                            <div class="tab-content">

                                @isset($s->activated_at) 
                                @if($s->activated_at !== null)
                                <h3 class="ui header">
                                    <i class="blue shield alternate icon"></i>
                                    <div class="content">
                                        @lang('setting.this_app')
                                    </div>
                                </h3>
                                <h4 class="ui grey header">@lang('setting.activating')</h4>
                                <div class="ui list">
                                    <div class="item">
                                        <i class="check blue icon"></i>
                                        <div class="content">
                                            <a class="ui grey sub header">@lang('setting.file')</a>
                                            <div class="description">@lang('setting.verify')</div>
                                        </div>
                                    </div>
                                    <div class="ui hidden divider thin"></div>
                                    <div class="item">
                                        <i class="check blue icon"></i>
                                        <div class="content">
                                            <a class="ui grey sub header">@lang('setting.suppiort_update')</a>
                                            <div class="description">@lang('setting.get_application')</div>
                                        </div>
                                    </div>
                                    <div class="ui hidden divider thin"></div>
                                    <div class="item">
                                        <i class="check blue icon"></i>
                                        <div class="content">
                                            <a class="ui grey sub header">@lang('setting.feature_custom')</a>
                                            <div class="description">@lang('setting.request_suggest')</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4 class="ui header">
                                    ...
                                    <div class="content">
                                            @lang('setting.deactive')
                                            <div class="sub header">@lang('setting.deactive_btn')</div>
                                    </div>
                                    <button id="reverse" data-id="{{ \Auth::user()->id }}"  class="ui red button small deactivate"><i class="undo icon"></i>@lang('setting.deactive_while')</button>
                                </h4>
                                <div class="ui ra negative message col-md-6" style="display:none">
                                ...
                                @if($s == "1")
                                <form id="item" class="ui form" method="post" accept-charset="utf-8">
                                    <div class="content">
                                        {{ csrf_field() }}
                                        <div class="eight wide field">
                                            <h4 class="">@lang('setting.account_username')</h4>
                                            <label>@lang('setting.evanto_username')</label>
                                            <input type="text" id="u" value="" placeholder="Enter your Envato Account Username">
                                        </div>
                                        <div class="eight wide field">
                                            <label>@lang('setting.purchase_code')</label>
                                            <input type="text" id="c" value="" placeholder="Enter your Purchase code">
                                        </div>
                                        <div class="eight wide field">
                                            <div class="ui verify negative message" style="display:none">
                                                <i class="close icon"></i>
                                                <div class="header message_title"></div>
                                                <p class="message_content"></p>
                                            </div>
                                    ...
                                    <div class="actions align-left">
                                        <input type="hidden" id="i" value="@isset($ip){{ $ip }}@endisset" readonly>
                                        <button class="ui positive small button approve" type="submit"><i class="ui checkmark icon"></i> Activate</button>
                                    </div>
                                </form>
                                @endif
